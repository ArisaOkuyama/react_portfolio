  ...
  return (
    <>
      <div className="container">
        <p className="japa" onClick={onClick}>
          {store.language ? "日本語" : "ENGLISH"}
        </p>
        <img
          id="background-img"
          alt="me"
          src={require("../img/meandlake.jpg")}
        />
        <Ball
          left="88"
          bottom="24"
          color="rgb(240, 235, 165, 0.6)"
          height="1"
          width="1"
        />
